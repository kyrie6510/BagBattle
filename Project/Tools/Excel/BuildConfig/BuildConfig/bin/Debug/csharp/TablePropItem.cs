...
public struct TablePropItemRowData : IFlatbufferObject
{
  ...
  public int TimId(int j) { int o = __p.__offset(30); return o != 0 ? __p.bb.GetInt(__p.__vector(o) + j * 4) : (int)0; }
  public int TimIdLength { get { int o = __p.__offset(30); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<int> GetTimIdBytes() { return __p.__vector_as_span<int>(30, 4); }
#else
  public ArraySegment<byte>? GetTimIdBytes() { return __p.__vector_as_arraysegment(30); }
#endif
  public int[] GetTimIdArray() { return __p.__vector_as_array<int>(30); }
  public int EffectId(int j) { int o = __p.__offset(32); return o != 0 ? __p.bb.GetInt(__p.__vector(o) + j * 4) : (int)0; }
  public int EffectIdLength { get { int o = __p.__offset(32); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<int> GetEffectIdBytes() { return __p.__vector_as_span<int>(32, 4); }
#else
  public ArraySegment<byte>? GetEffectIdBytes() { return __p.__vector_as_arraysegment(32); }
#endif
  public int[] GetEffectIdArray() { return __p.__vector_as_array<int>(32); }
  public int EffectOfListen(int j) { int o = __p.__offset(34); return o != 0 ? __p.bb.GetInt(__p.__vector(o) + j * 4) : (int)0; }
  public int EffectOfListenLength { get { int o = __p.__offset(34); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<int> GetEffectOfListenBytes() { return __p.__vector_as_span<int>(34, 4); }
#else
  public ArraySegment<byte>? GetEffectOfListenBytes() { return __p.__vector_as_arraysegment(34); }
#endif
  public int[] GetEffectOfListenArray() { return __p.__vector_as_array<int>(34); }
  public short UIWidth { get { int o = __p.__offset(36); return o != 0 ? __p.bb.GetShort(o + __p.bb_pos) : (short)0; } }
  public short UIHeight { get { int o = __p.__offset(38); return o != 0 ? __p.bb.GetShort(o + __p.bb_pos) : (short)0; } }
  public string EffectDes { get { int o = __p.__offset(40); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetEffectDesBytes() { return __p.__vector_as_span<byte>(40, 1); }
#else
  public ArraySegment<byte>? GetEffectDesBytes() { return __p.__vector_as_arraysegment(40); }
#endif
  public byte[] GetEffectDesArray() { return __p.__vector_as_array<byte>(40); }
  public string TexturePath { get { int o = __p.__offset(42); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetTexturePathBytes() { return __p.__vector_as_span<byte>(42, 1); }
#else
  public ArraySegment<byte>? GetTexturePathBytes() { return __p.__vector_as_arraysegment(42); }
#endif
  public byte[] GetTexturePathArray() { return __p.__vector_as_array<byte>(42); }
  ...
  public static Offset<TablePropItemRowData> CreateTablePropItemRowData(FlatBufferBuilder builder,
      ...
      VectorOffset TimIdOffset = default(VectorOffset),
  ...
  public static void AddTimId(FlatBufferBuilder builder, VectorOffset TimIdOffset) { builder.AddOffset(13, TimIdOffset.Value, 0); }
  public static VectorOffset CreateTimIdVector(FlatBufferBuilder builder, int[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt(data[i]); return builder.EndVector(); }
  public static VectorOffset CreateTimIdVectorBlock(FlatBufferBuilder builder, int[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static void StartTimIdVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static void AddEffectId(FlatBufferBuilder builder, VectorOffset EffectIdOffset) { builder.AddOffset(14, EffectIdOffset.Value, 0); }
  ...
  public static void AddEffectOfListen(FlatBufferBuilder builder, VectorOffset EffectOfListenOffset) { builder.AddOffset(15, EffectOfListenOffset.Value, 0); }
  ...
  public static void AddEffectDes(FlatBufferBuilder builder, StringOffset EffectDesOffset) { builder.AddOffset(18, EffectDesOffset.Value, 0); }
  public static void AddTexturePath(FlatBufferBuilder builder, StringOffset TexturePathOffset) { builder.AddOffset(19, TexturePathOffset.Value, 0); }
