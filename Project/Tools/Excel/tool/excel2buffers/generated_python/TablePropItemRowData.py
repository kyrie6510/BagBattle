...
def StartItemGridTypeVector(builder, numElems): return builder.StartVector(2, numElems, 2)
def TablePropItemRowDataStartItemGridTypeVector(builder, numElems):
    """This method is deprecated. Please switch to Start."""
    return StartItemGridTypeVector(builder, numElems)
def AddWidth(builder, Width): builder.PrependInt16Slot(4, Width, 0)
...
def AddHeight(builder, Height): builder.PrependInt16Slot(5, Height, 0)
...
def AddUIWidth(builder, UIWidth): builder.PrependInt16Slot(6, UIWidth, 0)
...
def AddUIHeight(builder, UIHeight): builder.PrependInt16Slot(7, UIHeight, 0)
...
def AddTexturePath(builder, TexturePath): builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(TexturePath), 0)
